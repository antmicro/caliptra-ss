...
package otp_ctrl_reg_pkg;
  ...
  parameter int SwManufPartitionSize = 104;
  parameter int CptraCoreIdevidCertIdevidAttrOffset = 208;
  parameter int CptraCoreIdevidCertIdevidAttrSize = 96;
  parameter int SwManufPartitionDigestOffset = 304;
  parameter int SwManufPartitionDigestSize = 8;
  parameter int SecretLcTransitionPartitionOffset = 312;
  parameter int SecretLcTransitionPartitionSize = 184;
  parameter int CptraSsTestUnlockToken1Offset = 312;
  parameter int CptraSsTestUnlockToken1Size = 16;
  parameter int CptraSsTestUnlockToken2Offset = 328;
  parameter int CptraSsTestUnlockToken2Size = 16;
  parameter int CptraSsTestUnlockToken3Offset = 344;
  parameter int CptraSsTestUnlockToken3Size = 16;
  parameter int CptraSsTestUnlockToken4Offset = 360;
  parameter int CptraSsTestUnlockToken4Size = 16;
  parameter int CptraSsTestUnlockToken5Offset = 376;
  parameter int CptraSsTestUnlockToken5Size = 16;
  parameter int CptraSsTestUnlockToken6Offset = 392;
  parameter int CptraSsTestUnlockToken6Size = 16;
  parameter int CptraSsTestUnlockToken7Offset = 408;
  parameter int CptraSsTestUnlockToken7Size = 16;
  parameter int CptraSsTestExitToManufTokenOffset = 424;
  parameter int CptraSsTestExitToManufTokenSize = 16;
  parameter int CptraSsManufToProdTokenOffset = 440;
  parameter int CptraSsManufToProdTokenSize = 16;
  parameter int CptraSsProdToProdEndTokenOffset = 456;
  parameter int CptraSsProdToProdEndTokenSize = 16;
  parameter int CptraSsRmaTokenOffset = 472;
  parameter int CptraSsRmaTokenSize = 16;
  parameter int SecretLcTransitionPartitionDigestOffset = 488;
  parameter int SecretLcTransitionPartitionDigestSize = 8;
  parameter int LifeCycleOffset = 496;
  parameter int LifeCycleSize = 88;
  parameter int LcTransitionCntOffset = 496;
  parameter int LcTransitionCntSize = 48;
  parameter int LcStateOffset = 544;
  parameter int LcStateSize = 40;
  parameter int VendorHashesManufPartitionOffset = 584;
  parameter int VendorHashesManufPartitionSize = 152;
  parameter int CptraCoreVendorPkHash2Offset = 584;
  parameter int CptraCoreVendorPkHash2Size = 48;
  parameter int CptraCoreVendorPkHash3Offset = 632;
  parameter int CptraCoreVendorPkHash3Size = 48;
  parameter int CptraCoreVendorPkHash4Offset = 680;
  parameter int CptraCoreVendorPkHash4Size = 48;
  parameter int VendorHashesManufPartitionDigestOffset = 728;
  parameter int VendorHashesManufPartitionDigestSize = 8;
  parameter int VendorHashesOwnerProdPartitionOffset = 736;
  parameter int VendorHashesOwnerProdPartitionSize = 56;
  parameter int CptraSsOwnerPkHashOffset = 736;
  parameter int CptraSsOwnerPkHashSize = 48;
  parameter int VendorHashesOwnerProdPartitionDigestOffset = 784;
  parameter int VendorHashesOwnerProdPartitionDigestSize = 8;
  parameter int VendorHashesProdPartitionOffset = 792;
  parameter int VendorHashesProdPartitionSize = 56;
  parameter int CptraCoreVendorPkHash1Offset = 792;
  ...
  typedef struct packed {
    logic        q;
  } otp_ctrl_reg2hw_vendor_hashes_owner_prod_partition_read_lock_reg_t;
  ...
  typedef struct packed {
    ...
    struct packed {
      logic        d;
    } vendor_hashes_owner_prod_partition_error;
    struct packed {
      logic        d;
  ...
  typedef struct packed {
    logic [31:0] d;
  } otp_ctrl_hw2reg_vendor_hashes_owner_prod_partition_digest_mreg_t;
  ...
  typedef struct packed {
    otp_ctrl_reg2hw_intr_state_reg_t intr_state; // [238:237]
    otp_ctrl_reg2hw_intr_enable_reg_t intr_enable; // [236:235]
    otp_ctrl_reg2hw_intr_test_reg_t intr_test; // [234:231]
    otp_ctrl_reg2hw_alert_test_reg_t alert_test; // [230:221]
    otp_ctrl_reg2hw_direct_access_regwen_reg_t direct_access_regwen; // [220:219]
    otp_ctrl_reg2hw_direct_access_cmd_reg_t direct_access_cmd; // [218:213]
    otp_ctrl_reg2hw_direct_access_address_reg_t direct_access_address; // [212:201]
    otp_ctrl_reg2hw_direct_access_wdata_mreg_t [1:0] direct_access_wdata; // [200:137]
    otp_ctrl_reg2hw_check_trigger_reg_t check_trigger; // [136:133]
    otp_ctrl_reg2hw_check_timeout_reg_t check_timeout; // [132:101]
    otp_ctrl_reg2hw_integrity_check_period_reg_t integrity_check_period; // [100:69]
    otp_ctrl_reg2hw_consistency_check_period_reg_t consistency_check_period; // [68:37]
    otp_ctrl_reg2hw_sw_manuf_partition_read_lock_reg_t sw_manuf_partition_read_lock; // [36:36]
    otp_ctrl_reg2hw_vendor_hashes_manuf_partition_read_lock_reg_t
        vendor_hashes_manuf_partition_read_lock; // [35:35]
    otp_ctrl_reg2hw_vendor_hashes_owner_prod_partition_read_lock_reg_t
        vendor_hashes_owner_prod_partition_read_lock; // [34:34]
    otp_ctrl_reg2hw_vendor_hashes_prod_partition_read_lock_reg_t
        vendor_hashes_prod_partition_read_lock; // [33:33]
    otp_ctrl_reg2hw_vendor_non_secret_prod_partition_read_lock_reg_t
  ...
  typedef struct packed {
    otp_ctrl_hw2reg_intr_state_reg_t intr_state; // [842:839]
    otp_ctrl_hw2reg_status_reg_t status; // [838:817]
    otp_ctrl_hw2reg_err_code_mreg_t [15:0] err_code; // [816:769]
    ...
    otp_ctrl_hw2reg_vendor_hashes_owner_prod_partition_digest_mreg_t [1:0]
        vendor_hashes_owner_prod_partition_digest; // [127:64]
    otp_ctrl_hw2reg_vendor_hashes_prod_partition_digest_mreg_t [1:0]
        vendor_hashes_prod_partition_digest; // [63:0]
  ...
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_READ_LOCK_OFFSET = 13'h 8c;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK_OFFSET = 13'h 90;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_READ_LOCK_OFFSET = 13'h 94;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_NON_SECRET_PROD_PARTITION_READ_LOCK_OFFSET = 13'h 98;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_PK_HASH_VOLATILE_LOCK_OFFSET = 13'h 9c;
  parameter logic [CoreAw-1:0] OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_0_OFFSET = 13'h a0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_1_OFFSET = 13'h a4;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_0_OFFSET = 13'h a8;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_1_OFFSET = 13'h ac;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_0_OFFSET = 13'h b0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_1_OFFSET = 13'h b4;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_0_OFFSET = 13'h b8;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_1_OFFSET = 13'h bc;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_0_OFFSET = 13'h c0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_1_OFFSET = 13'h c4;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_0_OFFSET = 13'h c8;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_1_OFFSET = 13'h cc;
  parameter logic [CoreAw-1:0] OTP_CTRL_SW_MANUF_PARTITION_DIGEST_0_OFFSET = 13'h d0;
  parameter logic [CoreAw-1:0] OTP_CTRL_SW_MANUF_PARTITION_DIGEST_1_OFFSET = 13'h d4;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_0_OFFSET = 13'h d8;
  parameter logic [CoreAw-1:0] OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_1_OFFSET = 13'h dc;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_0_OFFSET = 13'h e0;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_1_OFFSET = 13'h e4;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0_OFFSET = 13'h e8;
  parameter logic [CoreAw-1:0] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1_OFFSET = 13'h ec;
  ...
  parameter logic [21:0] OTP_CTRL_STATUS_RESVAL = 22'h 0;
  ...
  parameter logic [0:0] OTP_CTRL_STATUS_VENDOR_HASHES_OWNER_PROD_PARTITION_ERROR_RESVAL = 1'h 0;
  ...
  parameter logic [31:0]
      ...
      32'h 0;
  parameter logic [31:0] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0_RESVAL = 32'h 0;
  parameter logic [31:0]
      OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0_RESVAL =
      32'h 0;
  parameter logic [31:0] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1_RESVAL = 32'h 0;
  parameter logic [31:0]
      OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1_RESVAL =
      32'h 0;
  ...
  typedef enum logic [31:0] {
    ...
    OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK,
    ...
    OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0,
    OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1,
  ...
  parameter logic [3:0] OTP_CTRL_CORE_PERMIT [62] = '{
    ...
    4'b 0001, // index[35] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_READ_LOCK
    4'b 0001, // index[36] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK
    4'b 0001, // index[37] OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_READ_LOCK
    4'b 0001, // index[38] OTP_CTRL_VENDOR_NON_SECRET_PROD_PARTITION_READ_LOCK
    4'b 1111, // index[39] OTP_CTRL_VENDOR_PK_HASH_VOLATILE_LOCK
    4'b 1111, // index[40] OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_0
    4'b 1111, // index[41] OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_1
    4'b 1111, // index[42] OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_0
    4'b 1111, // index[43] OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_1
    4'b 1111, // index[44] OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_0
    4'b 1111, // index[45] OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_1
    4'b 1111, // index[46] OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_0
    4'b 1111, // index[47] OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_1
    4'b 1111, // index[48] OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_0
    4'b 1111, // index[49] OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_1
    4'b 1111, // index[50] OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_0
    4'b 1111, // index[51] OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_1
    4'b 1111, // index[52] OTP_CTRL_SW_MANUF_PARTITION_DIGEST_0
    4'b 1111, // index[53] OTP_CTRL_SW_MANUF_PARTITION_DIGEST_1
    4'b 1111, // index[54] OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_0
    4'b 1111, // index[55] OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_1
    4'b 1111, // index[56] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_0
    4'b 1111, // index[57] OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_1
    4'b 1111, // index[58] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_0
    4'b 1111, // index[59] OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_1
