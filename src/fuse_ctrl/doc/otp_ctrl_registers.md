...
```wavejson
{"reg": [{"name": "VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK", "bits": 1, "attr": ["rw0c"], "rotate": -90}, {"bits": 31}], "config": {"lanes": 1, "fontsize": 10, "vspace": 460}}
```

|  Bits  |  Type  |  Reset  | Name                                         | Description                                                                                                              |
|:------:|:------:|:-------:|:---------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------|
|  31:1  |        |         |                                              | Reserved                                                                                                                 |
|   0    |  rw0c  |   0x1   | VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK | When cleared to 0, read access to the VENDOR_HASHES_OWNER_PROD_PARTITION partition is locked. Write 0 to clear this bit. |
...
## VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST
Integrity digest for the VENDOR_HASHES_OWNER_PROD_PARTITION partition.
The integrity digest is 0 by default. Software must write this
digest value via the direct access interface in order to lock the partition.
After a reset, write access to the VENDOR_HASHES_OWNER_PROD_PARTITION partition is locked and
the digest becomes visible in this CSR.
- Reset default: `0x0`
- Reset mask: `0xffffffff`
...
```wavejson
{"reg": [{"name": "VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST", "bits": 32, "attr": ["ro"], "rotate": 0}], "config": {"lanes": 1, "fontsize": 10, "vspace": 80}}
```

|  Bits  |  Type  |  Reset  | Name                                      | Description   |
|:------:|:------:|:-------:|:------------------------------------------|:--------------|
|  31:0  |   ro   |   0x0   | VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST |               |
