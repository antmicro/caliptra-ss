...
static uint32_t digest_registers[] = {
    ...
    SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_DIGEST_0,
    SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_DIGEST_1,
...
void main (void) {
    ...
    for (uint32_t i = 0; i < ARR_SIZE(read_lock_registers); i++) {
    ...
    for (uint32_t i = 0; i < ARR_SIZE(interrupt_registers); i++) {
    ...
    for (uint32_t i = 0; i < ARR_SIZE(check_registers); i++) {
    ...
    for (uint32_t i = 0; i < ARR_SIZE(digest_registers); i++) {
