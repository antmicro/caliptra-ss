...
#define CMD_FC_LCC_EXT_CLK_333MHZ       FC_LCC_CMD_OFFSET + 0x0d
...
#define CMD_FLASH_RMA_ERROR_DELAYED     FC_LCC_CMD_OFFSET + 0x23
#define CMD_OTP_PROG_ERROR_DELAYED      FC_LCC_CMD_OFFSET + 0x24
#define CMD_UNSTABLE_CLK_BYP_ACK        FC_LCC_CMD_OFFSET + 0x25
#define CMD_DISABLE_CPTR_DEBUG          FC_LCC_CMD_OFFSET + 0x26
#define CMD_RELEASE_CPTR_DEBUG          FC_LCC_CMD_OFFSET + 0x27
#define CMD_FC_FORCE_PPD                FC_LCC_CMD_OFFSET + 0x28
#define CMD_RELEASE_PPD                 FC_LCC_CMD_OFFSET + 0x29
#define CMD_LC_INJECT_INVALID_OTP_STATE FC_LCC_CMD_OFFSET + 0x2A
#define CMD_LC_RELEASE_OTP_STATE        FC_LCC_CMD_OFFSET + 0x2B
#define CMD_MCI_INJECT_STATE_ERROR      FC_LCC_CMD_OFFSET + 0x2C
#define CMD_MCI_RELEASE_STATE_ERROR     FC_LCC_CMD_OFFSET + 0x2D

#define TB_CMD_DISABLE_MCU_SRAM_PROT_ASSERTS 0xC0
#define TB_CHANGE_STRAP_MCU_LSU_AXI_USER     0xC1
#define TB_RELEASE_STRAP_MCU_LSU_AXI_USER    0xC2
...
#define TB_CMD_INJECT_AGG_ERROR_FATAL_DIRECT 0xf2
#define TB_CMD_INJECT_AGG_ERROR_NON_FATAL_DIRECT 0xf3
