...
typedef enum {
    ...
    CPTRA_CORE_VENDOR_PK_HASH_0 = 0x0250,
    CPTRA_CORE_VENDOR_PK_HASH_0_VALID = 0x0280,
    CPTRA_CORE_VENDOR_PK_HASH_1 = 0x0284,
    CPTRA_CORE_VENDOR_PK_HASH_1_VALID = 0x02B4,
    CPTRA_CORE_VENDOR_PK_HASH_2 = 0x02B8,
    CPTRA_CORE_VENDOR_PK_HASH_2_VALID = 0x02E8,
    // VENDOR_HASHES_OWNER_PROD_PARTITION
    CPTRA_SS_OWNER_PK_HASH = 0x02F8,
    CPTRA_SS_OWNER_PK_HASH_VALID = 0x0328,
    // VENDOR_HASHES_PROD_PARTITION
    CPTRA_CORE_VENDOR_PK_HASH_3 = 0x0338,
    CPTRA_CORE_VENDOR_PK_HASH_3_VALID = 0x0368,
    // VENDOR_REVOCATIONS_PROD_PARTITION
    CPTRA_SS_OWNER_ECC_REVOCATION = 0x0378,
    CPTRA_SS_OWNER_MLDSA_REVOCATION = 0x037C,
    CPTRA_CORE_ECC_REVOCATION_0 = 0x0380,
    CPTRA_CORE_MLDSA_REVOCATION_0 = 0x0384,
    CPTRA_CORE_ECC_REVOCATION_1 = 0x0388,
    CPTRA_CORE_MLDSA_REVOCATION_1 = 0x038C,
    CPTRA_CORE_ECC_REVOCATION_2 = 0x0390,
    CPTRA_CORE_MLDSA_REVOCATION_2 = 0x0394,
    CPTRA_CORE_ECC_REVOCATION_3 = 0x0398,
    CPTRA_CORE_MLDSA_REVOCATION_3 = 0x039C,
...
uint32_t vendor_hashes_manuf_partition_fuses[] = {
    ...
    CPTRA_CORE_VENDOR_PK_HASH_0_VALID,
