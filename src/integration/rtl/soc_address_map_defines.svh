...
`define SOC_OTP_CTRL_DIRECT_ACCESS_REGWEN                                                           (32'h70000054)
`define SOC_OTP_CTRL_DIRECT_ACCESS_CMD                                                              (32'h70000058)
`define SOC_OTP_CTRL_DIRECT_ACCESS_ADDRESS                                                          (32'h7000005c)
`define SOC_OTP_CTRL_DAI_WDATA_RF_START                                                             (32'h70000060)
`define SOC_OTP_CTRL_DAI_WDATA_RF_DIRECT_ACCESS_WDATA_0                                             (32'h70000060)
`define SOC_OTP_CTRL_DAI_WDATA_RF_DIRECT_ACCESS_WDATA_1                                             (32'h70000064)
`define SOC_OTP_CTRL_DAI_RDATA_RF_START                                                             (32'h70000068)
`define SOC_OTP_CTRL_DAI_RDATA_RF_DIRECT_ACCESS_RDATA_0                                             (32'h70000068)
`define SOC_OTP_CTRL_DAI_RDATA_RF_DIRECT_ACCESS_RDATA_1                                             (32'h7000006c)
`define SOC_OTP_CTRL_CHECK_TRIGGER_REGWEN                                                           (32'h70000070)
`define SOC_OTP_CTRL_CHECK_TRIGGER                                                                  (32'h70000074)
`define SOC_OTP_CTRL_CHECK_REGWEN                                                                   (32'h70000078)
`define SOC_OTP_CTRL_CHECK_TIMEOUT                                                                  (32'h7000007c)
`define SOC_OTP_CTRL_INTEGRITY_CHECK_PERIOD                                                         (32'h70000080)
`define SOC_OTP_CTRL_CONSISTENCY_CHECK_PERIOD                                                       (32'h70000084)
`define SOC_OTP_CTRL_SW_MANUF_PARTITION_READ_LOCK                                                   (32'h70000088)
`define SOC_OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_READ_LOCK                                        (32'h7000008c)
`define SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_READ_LOCK                                   (32'h70000090)
`define SOC_OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_READ_LOCK                                         (32'h70000094)
`define SOC_OTP_CTRL_VENDOR_NON_SECRET_PROD_PARTITION_READ_LOCK                                     (32'h70000098)
`define SOC_OTP_CTRL_VENDOR_PK_HASH_VOLATILE_LOCK                                                   (32'h7000009c)
`define SOC_OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_START                                          (32'h700000a0)
`define SOC_OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_DIGEST_0                                       (32'h700000a0)
`define SOC_OTP_CTRL_SW_TEST_UNLOCK_PARTITION_DIGEST_DIGEST_1                                       (32'h700000a4)
`define SOC_OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_START                                            (32'h700000a8)
`define SOC_OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_DIGEST_0                                         (32'h700000a8)
`define SOC_OTP_CTRL_SECRET_MANUF_PARTITION_DIGEST_DIGEST_1                                         (32'h700000ac)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_START                                           (32'h700000b0)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_DIGEST_0                                        (32'h700000b0)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_0_DIGEST_DIGEST_1                                        (32'h700000b4)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_START                                           (32'h700000b8)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_DIGEST_0                                        (32'h700000b8)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_1_DIGEST_DIGEST_1                                        (32'h700000bc)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_START                                           (32'h700000c0)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_DIGEST_0                                        (32'h700000c0)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_2_DIGEST_DIGEST_1                                        (32'h700000c4)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_START                                           (32'h700000c8)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_DIGEST_0                                        (32'h700000c8)
`define SOC_OTP_CTRL_SECRET_PROD_PARTITION_3_DIGEST_DIGEST_1                                        (32'h700000cc)
`define SOC_OTP_CTRL_SW_MANUF_PARTITION_DIGEST_START                                                (32'h700000d0)
`define SOC_OTP_CTRL_SW_MANUF_PARTITION_DIGEST_DIGEST_0                                             (32'h700000d0)
`define SOC_OTP_CTRL_SW_MANUF_PARTITION_DIGEST_DIGEST_1                                             (32'h700000d4)
`define SOC_OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_START                                    (32'h700000d8)
`define SOC_OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_DIGEST_0                                 (32'h700000d8)
`define SOC_OTP_CTRL_SECRET_LC_TRANSITION_PARTITION_DIGEST_DIGEST_1                                 (32'h700000dc)
`define SOC_OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_START                                     (32'h700000e0)
`define SOC_OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_DIGEST_0                                  (32'h700000e0)
`define SOC_OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_DIGEST_DIGEST_1                                  (32'h700000e4)
`define SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_START                                (32'h700000e8)
`define SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_DIGEST_0                             (32'h700000e8)
`define SOC_OTP_CTRL_VENDOR_HASHES_OWNER_PROD_PARTITION_DIGEST_DIGEST_1                             (32'h700000ec)
...
`define SOC_OTP_CTRL_CSR0                                                                           (32'h700000f8)
`define SOC_OTP_CTRL_CSR1                                                                           (32'h700000fc)
`define SOC_OTP_CTRL_CSR2                                                                           (32'h70000100)
`define SOC_OTP_CTRL_CSR3                                                                           (32'h70000104)
`define SOC_OTP_CTRL_CSR4                                                                           (32'h70000108)
`define SOC_OTP_CTRL_CSR5                                                                           (32'h7000010c)
`define SOC_OTP_CTRL_CSR6                                                                           (32'h70000110)
`define SOC_OTP_CTRL_CSR7                                                                           (32'h70000114)
