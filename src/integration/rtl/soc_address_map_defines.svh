...
`define SOC_OTP_CTRL_SVN_PARTITION_READ_LOCK                                                        (32'h70000090)
`define SOC_OTP_CTRL_VENDOR_HASHES_MANUF_PARTITION_READ_LOCK                                        (32'h70000094)
...
`define SOC_OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_DIGEST_START                                      (32'h700000f0)
`define SOC_OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_DIGEST_DIGEST_0                                   (32'h700000f0)
`define SOC_OTP_CTRL_VENDOR_HASHES_PROD_PARTITION_DIGEST_DIGEST_1                                   (32'h700000f4)
`define SOC_OTP_CTRL_VENDOR_REVOCATIONS_PROD_PARTITION_DIGEST_START                                 (32'h700000f8)
`define SOC_OTP_CTRL_VENDOR_REVOCATIONS_PROD_PARTITION_DIGEST_DIGEST_0                              (32'h700000f8)
`define SOC_OTP_CTRL_VENDOR_REVOCATIONS_PROD_PARTITION_DIGEST_DIGEST_1                              (32'h700000fc)
`define SOC_OTP_CTRL_CSR0                                                                           (32'h70000100)
`define SOC_OTP_CTRL_CSR1                                                                           (32'h70000104)
`define SOC_OTP_CTRL_CSR2                                                                           (32'h70000108)
`define SOC_OTP_CTRL_CSR3                                                                           (32'h7000010c)
`define SOC_OTP_CTRL_CSR4                                                                           (32'h70000110)
`define SOC_OTP_CTRL_CSR5                                                                           (32'h70000114)
`define SOC_OTP_CTRL_CSR6                                                                           (32'h70000118)
`define SOC_OTP_CTRL_CSR7                                                                           (32'h7000011c)
