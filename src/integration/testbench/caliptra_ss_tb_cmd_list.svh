...
localparam CMD_FLASH_RMA_ERROR_DELAYED      = FC_LCC_CMD_OFFSET + 8'h23;
localparam CMD_OTP_PROG_ERROR_DELAYED       = FC_LCC_CMD_OFFSET + 8'h24;
...
localparam TB_CHANGE_STRAP_MCU_LSU_AXI_USER  = 8'hC1;
localparam TB_RELEASE_STRAP_MCU_LSU_AXI_USER = 8'hC2;
...
localparam TB_CMD_INJECT_AGG_ERROR_FATAL_DIRECT = 8'hF2;
localparam TB_CMD_INJECT_AGG_ERROR_NON_FATAL_DIRECT = 8'hF3;
