...
from lib.reggen.alert import Alert
from lib.reggen.bus_interfaces import BusInterfaces
from lib.reggen.clocking import Clocking, ClockingItem
from lib.reggen.countermeasure import CounterMeasure
from lib.reggen.inter_signal import InterSignal
from lib.reggen.interrupt import Interrupt
from lib.reggen.lib import (check_bool, check_int, check_keys, check_list,
                        check_name)
from lib.reggen.params import LocalParam, ReggenParams
from lib.reggen.reg_block import RegBlock
from lib.reggen.signal import Signal
...
class IpBlock:
    ...
    def from_raw(param_defaults: List[Tuple[str, str]],
        ...
        return IpBlock(name, cip_id, None, regwidth, params, reg_blocks,
                       None, interrupts, no_auto_intr, alerts, no_auto_alert,
                       None, None, bus_interfaces, clocking, None,
                       None, None, False, False, False, node)
    ...
    def _asdict(self) -> Dict[str, object]:
        ...
        ret['version'] = "0.0.0"#str(self.version)
